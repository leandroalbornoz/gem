										...
										<tr>
											...
											<td align="center">
												<div class="input-group input-group-sm">
													<input type="text" class="form-control notas input-notas" value="<?= !empty($alumno->nota_evaluacion) ? $alumno->nota_evaluacion : ''; ?>" name="nota[<?= $alumno->id; ?>]" tabindex="<?= $index; ?>" <?= ($txt_btn !== 'Editar' || (!empty($alumno->asistencia) && $alumno->asistencia === "Ausente")) ? "readonly" : ""; ?>>
												</div>
											</td>
												...
												<?php if ($txt_btn === 'Editar'): ?>
													<div class="btn-group btn-group-xs inasistencia" data-toggle="buttons">
														<label class="btn btn-default cursada-si <?= (!empty($alumno->asistencia) ? ($alumno->asistencia === "Presente") ? "active" : "" : "active") ?>">
															<input type="radio" name="asistencia[<?= $alumno->id; ?>]" value="Presente" <?= (!empty($alumno->asistencia) ? ($alumno->asistencia === "Presente") ? "checked" : "" : "checked") ?>> Presente
														</label>
														<label class="btn btn-default cursada-no <?= (!empty($alumno->asistencia) ? ($alumno->asistencia === "Ausente") ? "active" : "" : "") ?>">
															<input type="radio" name="asistencia[<?= $alumno->id; ?>]" value="Ausente" <?= (!empty($alumno->asistencia) ? ($alumno->asistencia === "Ausente") ? "checked" : "" : "") ?>> Ausente
														</label>
													</div>
												<?php else: ?>	
