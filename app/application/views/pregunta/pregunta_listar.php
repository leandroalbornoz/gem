<div class="content-wrapper">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo $controlador; ?>">Preguntas</a></li>
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box box-primary">
					<div class="box-body">
						<a class="btn bg-blue btn-app btn-app-zetta" href="pregunta/modal_agregar" data-remote="false" data-toggle="modal" data-target="#remote_modal">
