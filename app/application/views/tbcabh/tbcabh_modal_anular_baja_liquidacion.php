...
<div class="modal-header">
	...
	<h4 class="modal-title">Anular baja de servicio</h4>
</div>
...
<div class="modal-footer">
	...
	<?php echo empty($novedades) ? form_submit(array('class' => 'btn btn-success pull-right', 'title' => 'Anular baja'), 'Anular baja') : 'La baja ha sido dada con una novedad'; ?>
</div>
<?php echo form_close(); ?>
