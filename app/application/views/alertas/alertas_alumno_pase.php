<div class="content-wrapper">
	<section class="content-header">
		<h1>
			Confirmar ingreso de alumnos a este establecimiento:
		</h1>
		<ol class="breadcrumb">
			...
			<li class="active">Confirmar ingreso de alumnos</li>
		</ol>
	</section>
...
<script>
	var alumno_pase_table;
	function complete_alumno_table() {
		agregar_filtros('alumno_pase_table', alumno_pase_table, 3);
	}
</script>