...
<div class="content-wrapper">
	<section class="content-header">
		<h1>
			Agregar servicio <?php echo "Esc. $escuela->nombre_corto" ?> - <label class="label label-default"><?php echo $mes; ?></label>
		</h1>
		<ol class="breadcrumb">
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box box-primary">
					<?php echo form_open(uri_string(), array('data-toggle' => 'validator', 'id' => 'form_agregar_servicio')); ?>
					<div class="box-body">
...
<script>
	...
	$(document).ready(function() {
		...
		agregar_eventos($('#form_agregar_servicio'));
...
//		$('#tipo_destino').selectize()[0].selectize.destroy();
