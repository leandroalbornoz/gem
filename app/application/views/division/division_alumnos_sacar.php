						...
						<div class="box-body">
							...
							<div class="btn-group pull-right" role="group" style="margin-left: 5px;">
								...
								<ul class="dropdown-menu dropdown-menu-right">
									...
									<?php endif; ?>
									<li><a class="dropdown-item btn-default" href="division/ver_horario/<?php echo (!empty($division->id)) ? $division->id : ''; ?>"><i class=" fa-fw fa-clock-o" id="btn-horarios"></i> Horarios</a></li>
								</ul>
							</div>
							<?php if ($edicion): ?>
								<div class="btn-group pull-right" role="group" style="margin-left: 5px;">
