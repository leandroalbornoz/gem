<div class="content-wrapper">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><?php echo "Mover"; ?></li>
		</ol>
	</section>
							...
							<div class="row">
								...
								<div class="form-group col-md-2">
									...
									<div class="input-group date" id="datepicker">
										<input type="text" class="form-control" name="ciclo_lectivo_nuevo" required id="ciclo_lectivo_nuevo" value="<?php echo $ciclo_lectivo; ?>"/>
...
<script>
	...
	$(document).ready(function() {
		$('#form_mover_alumnos').submit(verificar_fechas);
	});
</script>
