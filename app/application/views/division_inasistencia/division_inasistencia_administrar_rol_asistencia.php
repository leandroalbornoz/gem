<div class="content-wrapper">
	<section class="content-header">
		<h1>
			Usuarios de <?php echo "$division->curso $division->division"; ?>
		</h1>
		<ol class="breadcrumb">
			...
			<li><a href="division_inasistencia/listar/<?= $division->id ?>/<?= $ciclo_lectivo ?>"><?php echo "Division Inasistencia"; ?></a></li>
			...
			<div class="col-xs-12">
				<div class="box box-primary">
					<div class="box-body">
						<div class="row">
							<div class="col-md-12">
								<a class="btn btn-app btn-app-zetta" href="division_inasistencia/listar/<?= $division->id ?>/<?= $ciclo_lectivo ?>">
									<i class="fa fa-clock-o"></i> Asistencia
								</a>
								<a class="btn bg-blue btn-app btn-app-zetta" data-remote="false" data-toggle="modal" data-target="#remote_modal_lg"  href="division_inasistencia/modal_buscar_usuarios/<?php echo "$division->id"; ?>">
