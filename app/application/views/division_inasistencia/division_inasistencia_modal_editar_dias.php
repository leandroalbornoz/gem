	...
	<div class="row">
		<div class="col-sm-6 form-group">
			...
			<?php echo $fields['dias']['label']; ?>
						<input type="number" name="dias" value="<?php echo $dias; ?>" max="<?php echo $dias_max_cursado; ?>" min="0" id="dias" class="form-control" pattern="^(0|[1-9][0-9]*)$" title="Debe ingresar sólo números" autocomplete="off">
...
<div class="modal-footer">
	...
	<?php echo (!empty($txt_btn)) ? form_submit(array('class' => 'btn btn-warning pull-right', 'title' => $txt_btn), $txt_btn) : ''; ?>
</div>
<?php echo form_close(); ?>
<script>
