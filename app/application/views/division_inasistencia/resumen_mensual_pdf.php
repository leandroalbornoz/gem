				...
				<table class="table table-hover table-bordered table-condensed text-sm open" role="grid">
					...
					<tbody>
						<tr>
							...
							<?php endif; ?>
							<th style="width: 9%;" rowspan="2">Documento</th>
							<th style="width: 15%;" rowspan="2">Nombre</th>
							<th style="text-align: center; width: 6%;" rowspan="2">Fecha<br>Ingreso</th>
							<th style="text-align: center; width: 6%;" rowspan="2">Fecha<br>Egreso</th>
							<th style="text-align: center;" colspan="2">Resumen Mensual</th>
							<th style="text-align: center;" colspan="2">Acumuladas</th>
							<th style="text-align: center;" colspan="2">Totales</th>
							<th style="text-align: center; width: 6%;" rowspan="2">Total<br>mes</th>
							<th style="text-align: center; width: 6%;" rowspan="2">Asistencia</th>
							<th style="text-align: center; width: 6%;" rowspan="2">% Asistencia</th>
						</tr>
						<tr>
				...
				<div class="row">
					...
					<?php if ($division_inasistencia->fecha_cierre): ?>
						...
						<?php foreach ($alumnos as $alumno): ?>
							...
							<?php $total_general_asistencia_ideal += $asistencia_ideal; ?>
						<?php endforeach; ?>
						<div style="width: 40%;float:right;padding-right: 15px;padding-left: 15px;">
							<table class="table table-hover table-bordered table-condensed text-sm" style="width: 90%;">
								<tr>
