...
class Rrhh extends MY_Controller {
	...
	public function exportar_pdf($escuela_id = NULL) {
		...
		exportMPDF($content, 'plugins/kv-mpdf-bootstrap.min.css', 'Declaración jurada de planta de celadores', "Escuela N°$escuela->numero - $escuela->nombre", '|{PAGENO} de {nb}|', 'LEGAL-L', $watermark, 'I', FALSE, FALSE);
	}
