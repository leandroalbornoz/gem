	...
	function load_permisos_nav($rol, $route) {
		...
		switch ($rol->codigo) {
			...
			case ROL_SEC_ESCUELA:
				...
				if (in_array(substr($escuela, 0, 1), array('0', '1', '2', '4', '8', '9'))) {
					$nav .= '<li><a class="text-green" href="becas/escuela/recepcion/' . $rol->entidad_id . '"><i class="fa fa-graduation-cap"></i><span>Recepción Becas</span></a></li>';
				}
			...
			case ROL_MODULO:
				switch ($rol->entidad_id) {
					...
					case ROL_MODULO_ADMINISTRADOR_DE_JUNTAS:
						...
						$nav .= '<li><a href="juntas/escritorio/consulta_turno"><i class="fa fa-phone text-blue"></i> <span >Consultar turnos</span></a></li>';
						$nav .= '</ul>';
						$nav .= '</li>';
						break;
