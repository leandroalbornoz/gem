...
switch (ENVIRONMENT) {
	case 'development':
		defined('BASE_URL') OR define('BASE_URL', 'https://testing.mendoza.edu.ar/gem/app/');
//		defined('APP_KEY') OR define('APP_KEY', '{E099D4D3-B526-0B0F-45ED-DF7D073C104A}');
		...
		defined('DIRECTORIO') OR define('DIRECTORIO', 'C:/xampp/htdocs/gem/app/');
		defined('PORTAL') OR define('PORTAL', '1');
		break;
	case 'testing':
...
defined('AMES_LIQUIDACION') OR define('AMES_LIQUIDACION', '201805');
...
defined('ROL_DOCENTE') OR define('ROL_DOCENTE', 'docente_division');
...
defined('ROL_GRUPO_ESCUELA_CONSULTA') OR define('ROL_GRUPO_ESCUELA_CONSULTA', 'grupo_escuela_cons');
defined('ROL_TITULO') OR define('ROL_TITULO', 'titulo');
defined('ROL_BONO_SECUNDARIO') OR define('ROL_BONO_SECUNDARIO', 'bono_secundario');
defined('ROL_JUNTAS') OR define('ROL_JUNTAS', 'juntas');
defined('ROL_PORTAL') OR define('ROL_PORTAL', 'portal');
defined('ROL_MODULO') OR define('ROL_MODULO', 'modulo');
defined('ROL_ASISTENCIA_DIVISION') OR define('ROL_ASISTENCIA_DIVISION', 'asistencia_division');
defined('ROL_DOCENTE_CURSADA') OR define('ROL_DOCENTE_CURSADA', 'docente_cursada');
defined('ROL_MODULO_TITULOS') OR define('ROL_MODULO_TITULOS', '1');
defined('ROL_MODULO_LEER_ESCRIBIR') OR define('ROL_MODULO_LEER_ESCRIBIR', '2');
defined('ROL_MODULO_ADMINISTRADOR_DE_JUNTAS') OR define('ROL_MODULO_ADMINISTRADOR_DE_JUNTAS', '3');
defined('ROL_MODULO_OPERATIVO_APRENDER') OR define('ROL_MODULO_OPERATIVO_APRENDER', '4');
defined('ROL_MODULO_CONSULTA_TRAYECTORIA') OR define('ROL_MODULO_CONSULTA_TRAYECTORIA', '5');
defined('ROL_MODULO_REFERENTES_TRIBUNAL_CUENTAS') OR define('ROL_MODULO_REFERENTES_TRIBUNAL_CUENTAS', '6');
defined('ROL_MODULO_COMEDOR') OR define('ROL_MODULO_COMEDOR', '7');
defined('ROL_MODULO_TRANSPORTE') OR define('ROL_MODULO_TRANSPORTE', '8');
defined('ROL_MODULO_BECAS') OR define('ROL_MODULO_BECAS', '9');
defined('ROL_USI') OR define('ROL_USI', 'usi');
defined('ROLES') OR define('ROLES', implode(',', array(ROL_ADMIN, ROL_AREA, ROL_DIR_ESCUELA, ROL_PRIVADA, ROL_SEOS, ROL_LINEA, ROL_SUPERVISION, ROL_DOCENTE, ROL_SDIR_ESCUELA, ROL_SEC_ESCUELA, ROL_CONSULTA, ROL_CONSULTA_LINEA, ROL_JEFE_LIQUIDACION, ROL_LIQUIDACION, ROL_REGIONAL, ROL_ESCUELA_ALUM, ROL_ESCUELA_CAR, ROL_USI, ROL_GRUPO_ESCUELA, ROL_GRUPO_ESCUELA_CONSULTA, ROL_TITULO, ROL_BONO_SECUNDARIO, ROL_JUNTAS, ROL_MODULO, ROL_PORTAL, ROL_ASISTENCIA_DIVISION, ROL_DOCENTE_CURSADA)));
