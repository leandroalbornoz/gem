...
class Abono_motivo_alta_model extends MY_Model {

	public function __construct() {
		parent::__construct();
		$this->table_name = 'abono_motivo_alta';
		$this->msg_name = 'Motivo Alta';
		$this->id_name = 'id';
	...
	protected function _can_delete($delete_id) {
		if ($this->db->where('abono_motivo_alta_id', $delete_id)->count_all_results('abono_alumno') > 0) {
