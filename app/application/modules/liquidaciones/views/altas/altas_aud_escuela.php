	...
	<section class="content">
		...
		<div class="row">
			...
			<?php foreach ($estados as $estado_id => $estado): ?>
				<?php $count = empty($altas_estado[$estado]) ? 0 : count($altas_estado[$estado]); ?>
				<?php if ($count > 0): ?>
					<div class="col-xs-12">
						<div class="box box-primary">
							<?php echo form_open(uri_string(), array('data-toggle' => 'validator')); ?>
							<div class="box-header with-border">
								<h3 class="box-title"><span class="badge"><?= $count; ?></span> Altas <?= $estado_id; ?></h3>
								<div class="box-tools pull-right">
									<button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
								</div>
							</div>
							<div class="box-body">
								<table class="table table-condensed table-bordered table-striped">
									...
									<tbody>
										<?php foreach ($altas_estado[$estado] as $alta): ?>
											<tr>
												<td>
			...
			<?php if (!empty($casos_revisar)): ?>
				<div class="col-xs-12">
					<div class="box box-primary">
						<div class="box-header with-border">
							<h3 class="box-title"><span class="badge"><?= count($casos_revisar); ?></span> Casos a Revisar - Servicios activos sin liquidación actual</h3>
							<div class="box-tools pull-right">
								<button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
							</div>
						</div>
						<div class="box-body">
							<label>En los casos que efectivamente se deba realizar el alta del servicio, desde este menú se lo podrá incluir en auditoría para dar el alta al primer día del mes.</label>
									...
									<?php foreach ($casos_revisar as $caso): ?>
										<tr>
											...
											<td>
												...
												<br>
												<?php if ($this->edicion === TRUE): ?>
													<a class="text-sm btn btn-xs btn-success" href="liquidaciones/altas/modal_pasar_auditoria/<?php echo $escuela->id . '/' . $mes . '/' . $caso->servicio_id; ?>" data-remote="false" data-toggle="modal" data-target="#remote_modal" title="Editar"><i class="fa fa-arrow-up"></i></a>
												<?php endif; ?>
											</td>
											<td>
												<?= $caso->reemplaza_cuil; ?>
											...
											<td>
												<?php if ($this->edicion === TRUE): ?>
													<?php if ($estado === 'Cargado'): ?>
														...
														<br>
														<a class="btn btn-xs btn-danger" href="liquidaciones/altas/modal_rechazar/<?php echo $escuela->id . '/' . $mes . '/' . $caso->id; ?>" data-remote="false" data-toggle="modal" data-target="#remote_modal"><i class="fa fa-remove"></i> Rechazar</a>
													<?php elseif ($estado === 'Auditado'): ?>
