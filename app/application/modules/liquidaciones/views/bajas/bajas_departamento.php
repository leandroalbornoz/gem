...
<div class="content-wrapper">
	<section class="content-header">
		<h1>
			Auditoría de Bajas <?php echo $planilla_tipo->descripcion; ?> - <label class="label label-default"><?php echo empty($departamento) ? 'N/D' : $departamento->descripcion; ?></label> <label class="label label-default"><?php echo $mes; ?></label>
		</h1>
		<ol class="breadcrumb">
...
<script>
	...
	function complete_bajas_auditadas_table() {
		agregar_filtros('bajas_auditadas_table', bajas_auditadas_table, 8);
	}
