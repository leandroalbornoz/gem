			...
			<div class="col-xs-12">
				<div class="box box-primary">
					...
					<div class="box-footer">
						<a class="btn btn-default" href="comedor/escuela/ver/<?php echo $comedor_presupuesto->id; ?>" title="<?php echo empty($txt_btn) ? 'Volver' : 'Cancelar'; ?>"><?php echo empty($txt_btn) ? 'Volver' : 'Cancelar'; ?></a>
					</div>
				</div>
			</div>
		</div>
