...
<div class="modal-footer">
	<div class="col-sm-12">
		<?php if ($permitido): ?>
			...
			<a class="btn btn-primary pull-right" href="tem/personal/eliminar/<?php echo "$servicio->id"; ?>/<?php echo $servicio_novedad->id ?>" title="Ir a eliminar servicio">Ir a eliminar servicio</a>
		<?php else: ?>
