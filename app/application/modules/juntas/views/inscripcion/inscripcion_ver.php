			...
			<div class="col-xs-12">
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<?php if (isset($persona_gem) && !empty($persona_gem)): ?>
							<div class="col-md-6" style="border-left: 3px solid black">
								<div class="row">
									<div class="col-md-12" style="text-align: center"><h4><u><b>GEM</b></u></h4></div>
								</div>
								<div class="row">
									<div class="form-group col-md-6">
										...
										<?php if (isset($titulos_persona) && !empty($titulos_persona)): ?>
											<?php foreach ($titulos_persona as $titulo): ?>
												<tr>
													...
													<td>
														<span><?= (isset($titulo->estado) && $titulo->estado == '0') ? "<i class='fa fa-remove fa-lg'style='color:red'></i>" : '' ?></span> 
														<span><?= (isset($titulo->estado) && $titulo->estado == '1') ? "<i class='fa fa-check fa-lg' style='color:green'></i>" : '' ?></span>
													</td>
												</tr>
											<?php endforeach; ?> 
										<?php else: ?>
										...
										<?php if (isset($postitulos_persona) && !empty($postitulos_persona)): ?>
											<?php foreach ($postitulos_persona as $postitulo): ?>
												<tr>
													...
													<td>
														<span><?= (isset($postitulo->estado) && $titulo->estado == '0') ? "<i class='fa fa-remove fa-lg'style='color:red'></i>" : '' ?></span> 
														<span><?= (isset($postitulo->estado) && $titulo->estado == '1') ? "<i class='fa fa-check fa-lg' style='color:green'></i>" : '' ?></span>
													</td>
												</tr>
											<?php endforeach; ?> 
										<?php else: ?>
										...
										<?php if (isset($posgrados_persona) && !empty($posgrados_persona)): ?>
											<?php foreach ($posgrados_persona as $posgrado): ?>
												<tr>
													...
													<td>
														<span><?= (isset($posgrado->estado) && $titulo->estado == '0') ? "<i class='fa fa-remove fa-lg'style='color:red'></i>" : '' ?></span> 
														<span><?= (isset($posgrado->estado) && $titulo->estado == '1') ? "<i class='fa fa-check fa-lg' style='color:green'></i>" : '' ?></span>
													</td>
												</tr>
											<?php endforeach; ?> 
										<?php else: ?>
										...
										<?php if (isset($antiguedad_persona) && !empty($antiguedad_persona)): ?>
											<?php foreach ($antiguedad_persona as $antiguedad): ?>
												<tr>
													...
													<td>
														<span><?= (isset($antiguedad->estado) && $antiguedad->estado == '0') ? "<i class='fa fa-remove fa-lg'style='color:red'></i>" : '' ?></span> 
														<span><?= (isset($antiguedad->estado) && $antiguedad->estado == '1') ? "<i class='fa fa-check fa-lg' style='color:green'></i>" : '' ?></span>
													</td>
												</tr>
											<?php endforeach; ?> 
										<?php else: ?>
										...
										<?php if (isset($antecedentes_persona) && !empty($antecedentes_persona)): ?>
											<?php foreach ($antecedentes_persona as $antecedente): ?>
												<tr>
													...
													<td>
														<span><?= (isset($antecedente->estado) && $antecedente->estado == '0') ? "<i class='fa fa-remove fa-lg'style='color:red'></i>" : '' ?></span> 
														<span><?= (isset($antecedente->estado) && $antecedente->estado == '1') ? "<i class='fa fa-check fa-lg' style='color:green'></i>" : '' ?></span>													</td>
												</tr>
											<?php endforeach; ?> 
										<?php else: ?>
											<tr>
					...
					<div class="box-footer">
						<a class="btn btn-default" href="juntas/escuela/listar_validadas/<?= $escuela->gem_id ?>" title="Cancelar">Cancelar</a>
					</div>
					<?php echo form_close(); ?>
				</div>
			</div>
