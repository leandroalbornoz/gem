...
class Cargo_horario extends MY_Controller {
	...
	public function modal_agregar($cargo_id, $dia_id, $servicio_id) {
		...
		if (empty($servicio) || ($servicio->cargo_id != $cargo->id)) {
		...
		if (isset($_POST) && !empty($_POST)) {
			if ($this->form_validation->run() === TRUE) {
				...
				redirect("areas/personal/horarios/$servicio->id", 'refresh');
			} else {
	...
	public function modal_carga_masiva($cargo_id = NULL, $servicio_id) {
