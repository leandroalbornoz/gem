...
class Area extends MY_Controller {
	...
	public function agregar() {
		...
		} elseif ($this->rol->codigo === ROL_ADMIN || $this->rol->codigo === ROL_USI) {
			$this->array_area_padre_control = $array_area_padre = $this->get_array('area', 'area', 'id', array(
				'select' => array('area.id', "CONCAT(area.codigo, ' - ', area.descripcion) as area"),
				'sort_by' => 'area.codigo'
		...
		$data['class'] = array('agregar' => 'active btn-app-zetta-active', 'ver' => 'disabled', 'editar' => 'disabled', 'eliminar' => 'disabled', 'personal' => 'disabled');
	...
	public function editar($id = NULL) {
		...
		$data['area'] = $area;
		$data['txt_btn'] = 'Editar';
		$data['class'] = array('agregar' => '', 'ver' => '', 'editar' => 'active btn-app-zetta-active', 'eliminar' => '', 'personal' => '');
	...
	public function eliminar($id = NULL) {
		...
		$data['class'] = array('agregar' => '', 'ver' => '', 'editar' => '', 'eliminar' => 'active btn-app-zetta-active', 'personal' => '');
	...
	public function ver($id = NULL) {
		...
		$data['area'] = $area;
		$data['txt_btn'] = NULL;
		$data['class'] = array('agregar' => '', 'ver' => 'active btn-app-zetta-active', 'editar' => '', 'eliminar' => '', 'personal' => '');
