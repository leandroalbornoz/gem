			...
			<div class="col-xs-12">
				<div class="box box-primary">
					<div class="box-body text-sm">
						<a class="btn btn-app btn-app-zetta btn-app-zetta-active active" href="bono_secundario/mensaje/bandeja">
						...
						<a class="btn btn-app btn-app-zetta" href="bono_secundario/mensaje/enviados">
...
<script>
	var mensaje_bandeja_table;
	function complete_mensaje_bandeja_table() {
		agregar_filtros('mensaje_bandeja_table', mensaje_bandeja_table, 7);
	}
</script>