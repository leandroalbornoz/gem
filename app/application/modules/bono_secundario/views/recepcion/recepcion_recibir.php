		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box box-primary">
					<?php $data_submit = array('class' => 'btn btn-primary pull-right', 'title' => $recibir, 'name' => 'recibir'); ?>
					<?php $data_submit2 = array('class' => 'btn btn-warning pull-right', 'title' => $recibir_forzar, 'style' => 'margin-right: 5px', 'name' => 'recibir'); ?>
										...
										<?php if (isset($titulos_persona) && !empty($titulos_persona)): ?>
											<?php foreach ($titulos_persona as $titulo): ?>
												<tr>
													...
													<td>
														<span><?= ($titulo->estado == 1) ? "<i class='fa fa-check fa-lg' style='color:green'></i>" : "<input type='checkbox' name='titulo_estado[]' value='$titulo->id'>" ?> </span> 
													</td>
												</tr>
											<?php endforeach; ?> 
										<?php else: ?>
										...
										<?php if (isset($postitulos_persona) && !empty($postitulos_persona)): ?>
											<?php foreach ($postitulos_persona as $postitulo): ?>
												<tr>
													...
													<td>
														<span><?= ($postitulo->estado == 1) ? "<i class='fa fa-check fa-lg' style='color:green'></i>" : "<input type='checkbox' name='titulo_estado[]' value='$postitulo->id'>" ?></span> 
													</td>
												</tr>
											<?php endforeach; ?> 
										<?php else: ?>
										...
										<?php if (isset($posgrados_persona) && !empty($posgrados_persona)): ?>
											<?php foreach ($posgrados_persona as $posgrado): ?>
												<tr>
													...
													<td>
														<span><?= ($posgrado->estado == 1) ? "<i class='fa fa-check fa-lg' style='color:green'></i>" : "<input type='checkbox' name='titulo_estado[]' value='$posgrado->id'>" ?></span> 
													</td>
												</tr>
											<?php endforeach; ?> 
										<?php else: ?>
										...
										<?php if (isset($antiguedad_persona) && !empty($antiguedad_persona)): ?>
											<?php foreach ($antiguedad_persona as $antiguedad): ?>
												<tr>
													...
													<td>
														<span><?= ($antiguedad->estado == 1) ? "<i class='fa fa-check fa-lg' style='color:green'></i>" : "<input type='checkbox' name='antiguedad_estado[]' value='$antiguedad->id'>" ?></span>
													</td>
												</tr>
											<?php endforeach; ?> 
										<?php else: ?>
										...
										<?php if (isset($antecedentes_persona) && !empty($antecedentes_persona)): ?>
											<?php foreach ($antecedentes_persona as $antecedente): ?>
												<tr>
													...
													<td>
														<span><?= ($antecedente->estado == 1) ? "<i class='fa fa-check fa-lg' style='color:green'></i>" : "<input type='checkbox' name='antecedente_estado[]' value='$antecedente->id'>" ?></span>
													</td>
												</tr>
											<?php endforeach; ?> 
										<?php else: ?>
					...
					<div class="box-footer">
						<a class="btn btn-default" href="escritorio" title="Cancelar">Cancelar</a>
						<?php echo (!empty($recibir)) ? form_submit($data_submit, $recibir) : ""; ?>
						<?php echo (!empty($recibir_forzar)) ? form_submit($data_submit2, $recibir_forzar) : ""; ?>
