...
<div class="content-wrapper">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><?php echo "2° Instancia"; ?></li>
		</ol>
	</section>
			...
			<div class="col-xs-12">
				<div class="box box-primary">
					...
					<div class="box-header with-border">
						<h3 class="box-title">Esc. <?php echo $escuela->nombre_largo; ?> - Preinscripción a 1° grado <?php echo $ciclo_lectivo; ?> - 2° Instancia</h3>
					</div>
					<div class="box-body">
						<a class="btn btn-app btn-app-zetta <?php echo $class['ver']; ?>" href="preinscripciones/escuela/instancia_2/<?php echo "$preinscripcion->ciclo_lectivo/$escuela->id/$redireccion"; ?>">
						...
						<div class="dropdown pull-right">
							...
							<ul class="dropdown-menu menu-right" aria-labelledby="dropdownMenu1">
								...
								<li><a class="dropdown-item  bg-default" href="preinscripciones/escuela/anexo1_excel/<?php echo $preinscripcion->id ?>/2/<?php echo "$redireccion" ?>" title="Exportar Excel"><i class="fa fa-file-excel-o"></i> Inscriptos</a></li>
								<li><a class="dropdown-item  bg-default" href="preinscripciones/escuela/anexo3_excel/<?php echo $preinscripcion->id ?>/2/<?php echo "$redireccion" ?>" title="Exportar excel"><i class="fa fa-file-excel-o"></i> Excedentes</a></li>
							</ul>
						</div>
						<table class="table table-hover table-bordered table-condensed dt-responsive dataTable no-footer dtr-inline" role="grid">
							<thead>
								...
								<tr style="background-color: #e4e4e4" >
									<th style="text-align: center;" colspan="9">
										<div style="width:25px; margin: 2px ;" class="pull-left bg-green"><?php echo (($preinscripcion->vacantes - $preinscripcion->instancia_1)); ?></div>
							...
							<tbody class="open">
								<tr style="background-color: #d4d4d4" class="parent" >
									<th style="text-align: center; border-color: gray !important;" colspan="9">
										<div style="width:25px; margin: 2px ;" class="pull-left bg-green-active"><?php echo!empty($alumnos[4]) ? $preinscripcion->instancia_2_i : 0; ?></div>
										<div style="width:80px" class="pull-left">
											<?php if ($fecha <= $fecha_hasta): ?>
												<?php if ($preinscripcion->inscriptos < $preinscripcion->vacantes): ?>
													<a class="btn btn-xs bg-blue pull-left" id="persona_buscar_listar_1" href="preinscripciones/preinscripcion_alumno/modal_buscar/<?php echo $preinscripcion->id; ?>/4/<?php echo "$redireccion" ?>" data-remote="false" data-toggle="modal" data-target="#remote_modal"><i class="fa fa-plus"></i> Agregar
													</a>
												<?php else : ?>
													<span>&nbsp;</span>
												<?php endif; ?>
							...
							<tr style="background-color: #e4e4e4" >
								<th style="text-align: center; border-color: gray !important;" colspan="9">
									<div style="width:25px; margin: 2px ;" class="pull-left bg-green-active"><?php echo (($preinscripcion->vacantes - $preinscripcion->instancia_1 - $preinscripcion->instancia_2_i)); ?></div>
							...
							<tbody class="open">
								...
								<tr style="background-color: #d4d4d4" class="parent" >
									<th style="text-align: center; border-color: gray !important;" colspan="9">
										<div style="width:25px; margin: 2px ;" class="pull-left bg-green-active"><?php echo!empty($alumnos[4]) ? $preinscripcion->postulantes + $preinscripcion->derivados : 0; ?></div>
										<div style="width:80px" class="pull-left">
											<?php if ($fecha <= $fecha_hasta): ?>
												<?php if ($preinscripcion->inscriptos >= $preinscripcion->vacantes): ?>
													<a class="btn btn-xs bg-blue pull-left" id="persona_buscar_listar_1" href="preinscripciones/preinscripcion_alumno/modal_buscar/<?php echo $preinscripcion->id; ?>/4/<?php echo "$redireccion" ?>" data-remote="false" data-toggle="modal" data-target="#remote_modal"><i class="fa fa-plus"></i> Agregar
