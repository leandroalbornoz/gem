	...
	<body class="hold-transition login-page">
		<div class="login-box">
			...
			<div class="form">
				...
				<div class="form-group has-feedback">
					<p><strong><u>Datos personales del padre: </u></strong></p>
					<p>Apellido y nombre: <?php echo $datos->padre_nombre; ?></p>
					<p>Documento: <?php echo $datos->padre_dni; ?></p>
				...
				<div class="form-group has-feedback">
					<p><strong><u>Datos personales del hijo: </u></strong></p>
					<p>Apellido y nombre: <?php echo $datos->hijo_nombre; ?></p>
					<p>Documento: <?php echo $datos->hijo_dni; ?></p>
				</div>
				<div class="form-group has-feedback">
				...
				<?php if (!isset($usuario_creado)): ?>
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<?php else: ?>
								<?php echo form_hidden('dni_padres', $dni_padres); ?>
								...
								<label style="font-size: 13px; text-align: right; width: 100%; margin-top: 20px;">
									<a class="text-center need-help" href="portal/auth/verificar_usuario_padre/">Volver</a>
								</label>
							<?php endif; ?>
						</div>
					</div>
		...
		<script>
			...
			$(document).ready(function() {
				$("#cuil_padres").inputmask("99-99999999-9", {placeholder: "_"});
			});
			...
			function verificar_datos(event) {
				var cuil = $('#cuil_padres').val();
				var mail = $('#mail_padres').val();
				var ter_cond = $('checkbox').val();
				console.log(ter_cond);
				if (cuil == '' || mail == '') {
					if (cuil == '') {
