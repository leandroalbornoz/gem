...
<html>
	...
	<body class="hold-transition login-page">
		<div class="login-box">
			...
			<div class="form">
				<p class="login-box-msg">Por favor, ingrese su correo electrónico o usuario</p>
				<?php if (!empty($error)) : ?>
				...
				<div class="row">
					<div class="col-xs-12">
						<?php echo form_submit('submit', 'Recuperar', 'class="btn btn-primary btn-block btn-flat"'); ?>
