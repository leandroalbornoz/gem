														...
														<?php foreach ($reporte_mes as $mes => $reporte): ?>
															<table id="reporte_table" class="table table-hover table-bordered table-condensed" role="grid" >
																<thead>
																	...
																	<tr>
																		<th style="padding-left: 8px;"><?php echo ucfirst($detalle); ?></th>
																...
																<tbody>
																	<?php foreach ($reporte as $reporte_supervision_mes): ?>
																		<tr>
																			<td style="padding-left: 8px;"><?php echo $reporte_supervision_mes->{$detalle}; ?></td>
																			...
																			<td><?php echo "$reporte_supervision_mes->numero_escuelas"; ?></td>
																			<td><?php echo "$reporte_supervision_mes->numero_divisiones"; ?></td>
																			<td><?php echo "$reporte_supervision_mes->divisiones_riesgo"; ?></td>
