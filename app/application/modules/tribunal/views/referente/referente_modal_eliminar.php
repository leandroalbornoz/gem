...
<div class="modal-body">
	...
	<h4><u><strong>Último cheque</strong></u><span style="text-align:right; color:red; font-size: 18px; float: right;"><?php echo (!empty($ultimo_cheque)) ? "(Tiene campos cargados, no se puede eliminar)" : ""; ?></span></h4>
	<div class="row">
	...
	<h4><u><strong>Saldo de cuenta bancaria</strong></u><span style="text-align:right; color:red; font-size: 18px; float: right;"><?php echo (!empty($saldo)) ? "(Tiene campos cargados, no se puede eliminar)" : ""; ?></span></h4>
	<div class="row">
		<div class="form-group col-md-3">
	...
	<h4><u><strong>Fondos pendientes</strong></u><span style="text-align:right; color:red; font-size: 18px; float: right;"><?php echo (!empty($fondos_pendientes)) ? "(Tiene campos cargados, no se puede eliminar)" : ""; ?></span></h4>
	<div class="row">
		<div class="col-xs-12">
...
<div class="modal-footer">
	...
	<input type="submit" value="Eliminar" class="btn btn-danger pull-right" title="Eliminar"  <?php echo (!empty($saldo) || !empty($ultimo_cheque) || !empty($fondos_pendientes)) ? "disabled" : ""; ?>>
