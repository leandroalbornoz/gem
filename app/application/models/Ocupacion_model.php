...
class Ocupacion_model extends MY_Model {

	public function __construct() {
		parent::__construct();
		$this->table_name = 'ocupacion';
		$this->msg_name = 'Ocupación';
		$this->id_name = 'id';
	...
	protected function _can_delete($delete_id) {
		if ($this->db->where('ocupacion_id', $delete_id)->count_all_results('persona') > 0) {
...
/* End of file Ocupacion_model.php */
/* Location: ./application/models/Ocupacion_model.php */