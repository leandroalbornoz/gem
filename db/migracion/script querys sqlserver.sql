 -- DIVISIONES
 -- se migran a traves de sql server datos de las divisiones en el siguiente select
 -- tmp_division
...
-- CARGOS
 -- se migran a traves de sql server datos de los cargos en el siguiente select.
 -- tmp_cargo
...
-- PERSONA
 -- se migran a traves de sql server datos de las personas en el siguiente select.
 -- tmp_persona
