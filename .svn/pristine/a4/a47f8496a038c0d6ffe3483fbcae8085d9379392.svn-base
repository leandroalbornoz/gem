...
<div class="modal-body">
	<div class="panel panel-default col-sm-12">
		<p><b>De: </b><a href="juntas/escritorio/ver/<?= $conversacion[0]->persona_id ?>" target="_blank"><i class="fa fa-search"></i><?php echo $conversacion[0]->de; ?><span></span></a></p>
		<p><b>Para: </b><?php echo $conversacion[0]->para; ?></p>
		<p><b>Tema: </b><?php echo $conversacion[0]->tema; ?></p>
