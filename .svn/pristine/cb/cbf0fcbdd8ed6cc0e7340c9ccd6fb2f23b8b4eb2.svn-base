			...
			<div class="col-xs-4">
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title" style="font-weight: bold;">Información de la Cursada</h3>
						...
						<table id="tbl_ver_cargos" class="table table-hover table-bordered table-condensed text-sm  dt-responsive" role="grid" >
							<thead>
								<tr>
									...
									<th style="width: 10%;text-align: center;">División</th>
							...
							<tbody>
								<?php foreach ($cargos_cursada as $cc_id => $cargo_cursada): ?>
									<tr>
										...
										<td><?php echo "$cargo_cursada->curso $cargo_cursada->division"; ?></td>
								...
								<?php if (!empty($evaluaciones)): ?>
									<?php foreach ($evaluaciones as $evaluacion): ?>
										<tr>
											...
											<td style="text-align: center;">
												<div class="btn-group" role="group">
													<a class="btn btn-xs btn-default" href="evaluacion/ver/<?php echo "$evaluacion->id"; ?>" title="Ver">&nbsp;<i class="fa fa-search"></i>&nbsp;Ver</a>
													<button type="button" class="btn btn-xs btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="true"><span class="caret"></span></button>
													<ul class="dropdown-menu dropdown-menu-left">
								...
								<?php if (!empty($alumnos)): ?>
									<?php foreach ($alumnos as $alumno): ?>
										<tr>
											...
											<td style="text-align: center;">
												<div class="btn-group" role="group">
													<a href="alumno/ver/<?php echo $alumno->alumno_division_id ?>" target="_blank" class="btn btn-xs btn-default" title="Ver alumno"><i class="fa fa-search"></i>Ver</a>
