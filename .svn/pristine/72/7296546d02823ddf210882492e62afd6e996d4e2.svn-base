								...
								<ul class="list-group">
									...
									<li class="list-group-item">
										...
										<ul class="list-group">
											...
											<li class="list-group-item"><a class="btn btn-default" href="uploads/ayuda/alumnos_transicion_cl.pdf" target="_blank"><i class="fa fa-file-pdf-o"></i> Transición Ciclo lectivo <label class="badge bg-green" style="top: 2px; left: 2px;">Nuevo</label></a></li>
										</ul>
									</li>
									<li class="list-group-item">
										<h4>Portal</h4>
