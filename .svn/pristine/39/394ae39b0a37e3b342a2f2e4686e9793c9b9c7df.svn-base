								...
								if (result.personas_listar.length > 0) {
									for (var idx in result.personas_listar) {
										...
										table_personas_busqueda.row.add([
											...
											'<a class="btn btn-xs btn-success pull-right" href="alumno_division/agregar_existente/' +<?php echo $division->id; ?> + '/' +<?php echo $ciclo_lectivo; ?> + '/' + personas_listar.id + '"><i class="fa fa-plus"></i> Agregar</a>']);
									}
								}
								table_personas_busqueda.row.add([
									'X',
									...
									'',
									'<a  class="btn btn-xs btn-primary pull-right" href="alumno_division/agregar_nuevo/<?php echo $division->id; ?>/<?php echo $ciclo_lectivo; ?>"><i class="fa fa-plus"></i> Agregar</a>']);
