							...
							<ul>
								...
								<?php if ($escuela->nivel_id != '8'): ?>
									...
									<?php if ($escuela->nivel_id != '2'): ?>
										...
										<?php endif; ?>
									<?php endif; ?>
									<?php if ($escuela->nivel_id != '3' && $escuela->nivel_id != '4' && $escuela->nivel_id != '5'): ?>
										<li><h5><b><u>Compensación primaria</u>:</b> Alumno de nivel primario con periodo compensatorio.</h5></li>
									<?php endif; ?>
								<?php endif; ?>
								<?php if ($escuela->nivel_id != '2' && $escuela->nivel_id != '3' && $escuela->nivel_id != '4'): ?>
