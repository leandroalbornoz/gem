...
switch (ENVIRONMENT) {
	case 'development':
		defined('BASE_URL') OR define('BASE_URL', 'https://testing.mendoza.edu.ar/gem/appws/');
		defined('DIRECTORIO') OR define('DIRECTORIO', 'D:/svn/gem/app/');
		break;
	case 'testing':
		...
		break;
	case 'production':
		defined('BASE_URL') OR define('BASE_URL', 'http://dti.mendoza.edu.ar/gemws/');
		defined('DIRECTORIO') OR define('DIRECTORIO', '/home/web/html/gemws/');
		break;
}
