...
<div class="content-wrapper">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="titulos/<?php echo $controlador; ?>">Títulos - Personas</a></li>
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box box-primary">
					<div class="box-body">
						<a class="btn bg-blue btn-app btn-app-zetta" href="titulos/titulo_persona/agregar">
...
<script>
	...
	function complete_persona_table() {
		...
		$('#persona_table tfoot th').eq(8).html('<button class="btn btn-xs btn-default" onclick="limpiar_filtro(\'persona_table\');" title="Limpiar filtros"><i class="fa fa-eraser"></i> Filtros</button>');
