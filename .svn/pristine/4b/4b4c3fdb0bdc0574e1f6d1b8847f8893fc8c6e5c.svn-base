				...
				<div class="box box-primary">
					<div class="box-body">
						...
						<?php if ($edicion): ?>
							...
							<a class="btn btn-app btn-app-zetta" href="cargo/reubicar_servicios/<?php echo $escuela->id; ?>">
						...
						<a class="btn btn-app btn-app-zetta" href="cargo/excel/<?php echo "$escuela->id"; ?>">
