...
class Persona_antiguedad extends MY_Controller {
	...
	public function modal_agregar($servicio_id) {
		...
		$this->array_cargo_control = $this->persona_antiguedad_model->fields['cargo']['array'];
		$this->array_situacion_revista_control = $this->persona_antiguedad_model->fields['situacion_revista']['array'];
		...
		if (isset($_POST) && !empty($_POST)) {
			if ($this->form_validation->run() === TRUE) {
				...
				$trans_ok &= $this->persona_antiguedad_model->create(array(
					...
					'situacion_revista' => $this->input->post('situacion_revista'),
