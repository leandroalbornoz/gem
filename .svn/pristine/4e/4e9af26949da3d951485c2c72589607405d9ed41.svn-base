									...
									<div class="form-group col-md-12">
										<table class="table table-hover table-bordered table-condensed dt-responsive dataTable no-footer dtr-inline" role="grid">
											<thead>
												...
												<tr>
													<th style="width: 10%;">Curso/División</th>
												...
												<?php if (!empty($cargos_cursada)): ?>
													<?php foreach ($cargos_cursada as $cargo_cursada): ?>
														<tr>
															...
															<td><?php echo empty($cargo_cursada->carga_horaria) ? '' : $cargo_cursada->carga_horaria; ?></td>
															<td style="text-align: center;">
																<?php if (!empty($cargo_cursada)):; ?>
																	<a href="cursada/listar/<?php echo $cargo_cursada->division_id; ?>" class="btn btn-xs btn-default" target="_blank" title="Ver"><i class="fa fa-search"></i></a>
																	<a href="cargo_cursada/modal_editar/<?php echo $cargo_cursada->id; ?>" class="btn btn-xs btn-warning" data-remote="false" data-toggle="modal" data-target="#remote_modal" title="Editar"><i class="fa fa-pencil"></i></a>
																	<a href="cargo_cursada/modal_eliminar/<?php echo $cargo_cursada->id; ?>" class="btn btn-xs btn-danger" data-remote="false" data-toggle="modal" data-target="#remote_modal" title="Eliminar"><i class="fa fa-remove"></i></a>
																<?php endif; ?>
															</td>
														</tr>
													<?php endforeach; ?>
