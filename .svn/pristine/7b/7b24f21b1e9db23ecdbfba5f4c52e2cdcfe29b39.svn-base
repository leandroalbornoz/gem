		...
		<div class="row">
			...
			<div class="col-xs-12">
				<div class="box box-danger">
					<div class="box-header with-border">
						<h3 class="box-title">Barrido Abril GEM-SIGNOS</h3>
						<div class="box-tools pull-right">
							<button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
						</div>
					</div>
					<div class="box-body">
						<ul>
							<li>
								<b>Altas</b> - Se barrerán el 16/05/2018 a las 09:00 - Sistema cerrado desde las 09:00 a las 13:30
							</li>
							<li>
								<b>Bajas</b> - Se barrerán el 16/05/2018 a las 09:00 - Sistema cerrado desde las 09:00 a las 13:30
							</li>
						</ul>
						<b>En el caso de altas/bajas no auditadas al momento del barrido (que por lo tanto no fueron procesadas), se deberán auditar igualmente y cargar manualmente en SIGNOS.</b><br>
						<b>Las altas de Titulares se deben cargar manualmente en SIGNOS independientemente de si se auditaron o no antes del barrido.</b>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-xs-6">
					<div class="box box-primary">
						...
						<div class="box-footer">
							...
							<a class="btn btn-success pull-right" href="liquidaciones/altas/exportar_auditoria_excel/<?php echo $planilla_tipo->id . '/' . $mes; ?>"><i class="fa fa-file-excel-o"></i> Descargar</a>
						</div>
					</div>
				</div>
				<div class="col-xs-6">
					<div class="box box-primary">
						...
						<div class="box-footer">
							...
							<a class="btn btn-success pull-right" href="liquidaciones/bajas/exportar_auditoria_excel/<?php echo $planilla_tipo->id . '/' . $mes; ?>"><i class="fa fa-file-excel-o"></i> Descargar</a>
						</div>
					</div>
				</div>
			</div>
