...
<div class="content-wrapper">
	<section class="content-header">
		<h1>
			Novedades pendientes de <?php echo "$area->codigo $area->descripcion" ?> - <label class="label label-default"><?php echo $mes; ?></label>
		...
		<ol class="breadcrumb">
			...
			<li><a href="areas/personal_novedad/listar/<?php echo "$area->id/$mes_id"; ?>/1">Novedades pendientes</a></li>
			...
			<div class="col-xs-12">
				<div class="box box-primary">
					<div class="box-body">
						...
						<a class="btn btn-app btn-app-zetta active btn-app-zetta-active" href="areas/personal_novedad/listar/<?php echo "$area->id/$mes_id/1"; ?>">
...
<div class="modal fade" id="datepicker_modal" tabindex="-1" role="dialog" aria-labelledby="Modal" aria-hidden="true">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<?php echo form_open("areas/personal_novedad/cambiar_mes/$area->id/$mes_id/1"); ?>
...
<script>
	...
	function complete_personal_novedad_table() {
		agregar_filtros('personal_novedad_table', personal_novedad_table, 9);
	}
	function complete_personal_novedad_f_table() {
		agregar_filtros('personal_novedad_f_table', personal_novedad_f_table, 9);
	}
</script>
