<div class="content-wrapper">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><?php echo 'Listar TEM' . ($planilla->rectificativa !== '0' ? $planilla->rectificativa : '') ?></li>
		</ol>
	</section>
			...
			<div class="col-xs-12">
				<div class="box box-primary">
					...
					<div class="box-footer">
						<a class="btn btn-default" href="tem/asisnov/index/<?php echo $planilla->escuela_id . '/' . $planilla->ames; ?>" title="<?php echo empty($txt_btn) ? 'Volver' : 'Cancelar'; ?>"><?php echo empty($txt_btn) ? 'Volver' : 'Cancelar'; ?></a>
					</div>
				</div>
			</div>
		</div>
