<div class="content-wrapper">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Reporte por carrera</li>
		</ol>
	</section>
	<section class="content">
		...
		<div class="box box-primary">
			<div class="box-header with-border">
				<h3 class="box-title">Reporte de asistencia por Carrera</h3>
			</div>
			<div class="box-body">
				<div class="row">
					<div class="col-xs-3">
					...
					<div class="col-xs-3">
						<div class="form-group" id="select_carrera">
				...
				<div class="row">
					...
					<div class="col-xs-3">
						<div class="form-group" id="select_carrera">
							<?php echo $fields['divisiones_riesgo']['label']; ?>
							<?php echo $fields['divisiones_riesgo']['form']; ?>
						</div>
					</div>
				</div>
			</div>
			<div class="box-footer">
				...
				<?php echo form_hidden('reporte_carrera', true); ?>
			</div>
			<?php echo form_close(); ?>
		</div>
	</section>
