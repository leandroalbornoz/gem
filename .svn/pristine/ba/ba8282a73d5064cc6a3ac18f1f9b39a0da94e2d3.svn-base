...
<div class="modal-footer">
	<div class="col-sm-12">
		<?php if ($permitido): ?>
			...
			<a class="btn btn-primary pull-right" href="areas/personal/eliminar/<?php echo "$servicio->id/$servicio_novedad->id"; ?>" title="Ir a eliminar servicio">Ir a eliminar servicio</a>
		<?php else: ?>
