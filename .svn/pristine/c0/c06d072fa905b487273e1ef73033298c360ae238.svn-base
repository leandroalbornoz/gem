...
<div class="modal-header">
	...
	<h4 class="modal-title" id="myModalLabel"><strong><u><?php echo "Escuela</u>:</strong> $alumno_division->escuela"; ?></h4>
	<h4 class="modal-title" id="myModalLabel"><strong><u><?php echo "Curso y division</u>:</strong> $alumno_division->curso $alumno_division->division"; ?></h4>
	<h4 class="modal-title" id="myModalLabel"><strong><u><?php echo "Fecha de ingreso</u>:</strong> ".(!empty($alumno_division->fecha_desde) ? (new DateTime($alumno_division->fecha_desde))->format('d/m/Y') : "").""; ?></h4>
	<h4 class="modal-title" id="myModalLabel"><strong><u><?php echo "Fecha de egreso</u>:</strong> ".(!empty($alumno_division->fecha_hasta) ? (new DateTime($alumno_division->fecha_hasta))->format('d/m/Y'): "").""; ?></h4>
</div>
								...
								<td style="text-align: center;">
									<?php if (isset($alumno_inasistencia[$periodo->periodo][$fecha->format('Ym')])): ?>
										<?php if (empty($alumno_inasistencia[$periodo->periodo][$fecha->format('Ym')]->fecha_cierre)): ?>
											-Mes no cerrado-
										<?php else: ?>
											<?php echo (empty($alumno_inasistencia[$periodo->periodo][$fecha->format('Ym')]->falta_i) && empty($alumno_inasistencia[$periodo->periodo][$fecha->format('Ym')]->falta_j)) ? "100%" : (empty($alumno_inasistencia[$periodo->periodo][$fecha->format('Ym')]->asistencia) ? '0%' : (empty(($alumno_inasistencia[$periodo->periodo][$fecha->format('Ym')]->asistencia + $alumno_inasistencia[$periodo->periodo][$fecha->format('Ym')]->falta_i + $alumno_inasistencia[$periodo->periodo][$fecha->format('Ym')]->falta_j)) ? number_format(($alumno_inasistencia[$periodo->periodo][$fecha->format('Ym')]->asistencia * 100 ), 0, ',', '') . "%" : (number_format(($alumno_inasistencia[$periodo->periodo][$fecha->format('Ym')]->asistencia * 100 / ($alumno_inasistencia[$periodo->periodo][$fecha->format('Ym')]->asistencia + $alumno_inasistencia[$periodo->periodo][$fecha->format('Ym')]->falta_i + $alumno_inasistencia[$periodo->periodo][$fecha->format('Ym')]->falta_j)), 0, ',', '') . "%"))); ?>
										<?php endif; ?>
									<?php endif; ?>
								</td>
								<td style="text-align: center;">
