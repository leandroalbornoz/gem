<div class="content-wrapper">
	<section class="content-header">
		<h1>
			Auditoría de Altas <?php echo $planilla_tipo->descripcion; ?> - <label class="label label-default"><?php echo $mes; ?></label>
...
<script>
	...
	function format(altas) {
		...
		if (altas.length === 0) {
			html += '<tr><td colspan="6">No hay altas registradas por gem</td></tr>';
		} else {
