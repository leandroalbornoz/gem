...
$config['tables']['login_attempts']  = 'intento_ingreso';
 ...
 */
$config['site_title']                 = "G.E.M.";       // Site Title, example.com
$config['admin_email']                = "dge-sistemas@mendoza.gov.ar"; // Admin Email, admin@example.com
$config['default_group']              = 'users';           // Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['identity']                   = 'usuario';             // You can use any unique column in your table as identity column. The values in this column, alongside password, will be used for login purposes
 ...
 */
$config['remember_cookie_name'] = 'remember_dge_gem';
$config['identity_cookie_name'] = 'identity_dge_gem';
