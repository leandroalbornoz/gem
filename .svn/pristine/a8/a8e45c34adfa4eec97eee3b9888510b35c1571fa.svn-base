...
<div class="content-wrapper">
	<section class="content-header">
		<h1>
			Novedades pendientes de <?php echo "Esc. $escuela->nombre_corto" ?> - <label class="label label-default"><?php echo $mes; ?></label>
		...
		<ol class="breadcrumb">
			...
			<li><a href="servicio_novedad/listar/<?php echo "$escuela->id/$mes_id"; ?>/1">Novedades pendientes</a></li>
			...
			<div class="col-xs-12">
				<div class="box box-primary">
					<div class="box-body">
						...
						<a class="btn btn-app btn-app-zetta active btn-app-zetta-active" href="servicio_novedad/listar/<?php echo "$escuela->id/$mes_id/1"; ?>">
...
<div class="modal fade" id="datepicker_modal" tabindex="-1" role="dialog" aria-labelledby="Modal" aria-hidden="true">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<?php echo form_open("servicio_novedad/cambiar_mes/$escuela->id/$mes_id/1"); ?>
