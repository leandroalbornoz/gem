				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<?php if (in_array($this->rol->codigo, array(ROL_ADMIN, ROL_USI))): ?>
							<?php if (!empty($persona->cuil)): ?>
								<a target="_blank" class="btn bg-blue btn-app  btn-app-zetta" href="ddjj/declaracion/ver/<?php echo $persona->cuil; ?>">
									<i class="fa fa-file-pdf-o"></i> DDJJ
								</a>
							<?php endif; ?>
						<?php endif; ?>
