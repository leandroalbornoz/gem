<div class="content-wrapper">
	<section class="content-header">
		<h1>
			Unificar cargos de Esc. <?= $escuela->nombre_corto; ?>
		</h1>
		<ol class="breadcrumb">
			...
			<div class="col-xs-12">
				<div class="box box-primary">
					<div class="box-body">
						...
						<a class="btn btn-app btn-app-zetta active btn-app-zetta-active" href="cargo/unificar/<?php echo $escuela->id; ?>">
							<i class="fa fa-chain"></i> Unificar
						</a>
						<hr style="margin: 10px 0;">
						<p>Filtre los cargos que desea buscar, seleccionelos con <input disabled type="checkbox"> y presione el botón <span class="btn btn-primary btn-xs disabled">Unificar</span>.</p>
						<p>Sólo podrá unificar cargos que tengan igual <b>curso</b>, <b>división</b>, <b>espacio curricular</b>, <b>régimen</b> y <b>carga horaria</b>.</p>
...
<script>
	...
	function complete_cargo_table() {
		...
		$('#cargo_table thead th').eq(9).attr('style', 'width:10%;padding-right:0;');
